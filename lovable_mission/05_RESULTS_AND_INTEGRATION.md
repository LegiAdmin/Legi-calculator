...
Je veux maintenant que tu créer la section d'affichage des résultats qui va retourner ce que le calculateur a déterminer, ce qu'il va te renvoyer dans l'api. Tu dois donc avoir les legs spécifiques, la répartition (relative et absolue), les règles fiscal, les alertes (qutotité non légale etc) et tout autre considération qui te semblerait importante; Cette section doit être visuelle, limpide et soignée, en étant moderne. Pense à intégrer des infobulles ou indications qui aiderait l'utilisateur à comprendre cette répartition. 
